			...
			<?php
				...
				{	
					...
					<tr>
						...
						<td><input class="individual" type="checkbox"  id="q.top_<?php echo $row->tests_id;?>" name="question_top_<?php echo $row->tests_id;?>" value="<?php echo $row->tests_id;?>" <?php if($row->question_top == 1) echo 'checked="checked"';?> /></td>
						<td><input class="individual" type="checkbox"  id="q.top2_<?php echo $row->tests_id;?>" name="question_top2_<?php echo $row->tests_id;?>" value="<?php echo $row->tests_id;?>" <?php if($row->question_top2 == 1) echo 'checked="checked"';?> /></td>
