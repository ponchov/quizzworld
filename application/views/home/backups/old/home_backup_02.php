...
<div class="row">
	<div class="" style="min-height:350px; border:1px solid #FF0000; width:160px; float:left;"></div>
				...
				foreach($game_list as $game)
				{
					...
					?>
						...
						<div class="well">
							...
							<?php /*?><div class="row text-center"><a  href="<?php echo site_url();?>start/<?php echo $game->alias.".html"; if(isset($ref_page) && $ref_page=='top') echo"?ref_page=top";?>"><button style="font-size:30px;"  type="button" class="btn btn-lg btn-success col-xs-8 col-md-4 col-sm-4 start_btn">START</button></a></div><?php */?>
							<div style="clear:both;"></div>
							<div class="row  col-xs-12 col-md-5 col-sm-5 fb_like_share" style="min-height:42px;">
	...
	<div class="" style="min-height:350px; border:1px solid #FF0000; width:160px; float:right;"></div>
</div>
</div>
