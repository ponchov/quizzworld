	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="slide-nav">
		<div class="container"> 
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="<?php echo base_url();?>"><img class="img-resposive" src="<?php echo base_url();?>assets/templates/<?php echo $this->template;?>/img/logo.gif" alt="" style="height:33px;"/></a>
		   </div>
			...
			<ul class="nav navbar-nav">
				...
				<li><a class="button" href="<?php echo site_url();?>personality_quizz.html"><?php echo $this->lang->line('personality_quizz');?></a></li>
			...
			<div class="navbar-header domain_like_box visible-xs" style="float:left; width:105px; padding-top:15px;">
				<div class="fb-like" data-href="<?php echo $config_info->facebook_url;?>" data-width="320" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
			</div>
			<div class="navbar-header visible-xs pull-right" style="padding-right:15px;"><a class="" href="<?php echo base_url();?>"><img class="img-resposive" src="<?php echo base_url();?>assets/templates/<?php echo $this->template;?>/img/logo.gif" alt="" style="height:37px; padding-top:9px;"/></a></div>
