...
<div class="container">
	...
	<div id="main_container" class="col-xs-12 col-sm-10 col-md-8 " style="margin:auto; float:none !important;">

				<div class="well">

					<center><h4><strong>Privacy Policy for <a href="<?php echo site_url();?>">www.havefundaily.com</a></strong></h4>

<h5>
					<p>The privacy of our visitors to <a href="<?php echo site_url();?>">www.havefundaily.com</a> is important to us.</p>
					...
					<p>We also use third party advertisements on <a href="<?php echo site_url();?>">www.havefundaily.com</a> to support our site. Some of these advertisers may use technology such as cookies and web beacons when they advertise on our site, which will also send these advertisers (such as Google through the Google AdSense program) information including your IP address, your ISP , the browser you used to visit our site, and in some cases, whether you have Flash installed. This is generally used for geotargeting purposes (showing New York real estate ads to someone in New York, for example) or showing certain ads based on specific sites visited (such as showing cooking ads to someone who frequents cooking sites).</p>
					...
					<p>You can opt-out of this ad serving on all sites using this advertising by visiting <a href="http://www.google.com/privacy_ads.html" target="blank">this page</a></p>
					...
					<p>Deleting cookies does not mean you are permanently opted out of any advertising program. Unless you have settings that disallow cookies, the next time you visit a site running the advertisements, a new cookie will be added.</p></h3>
		...
		<div class="fb-like-box visible-lg visible-md"  data-width="684" data-href="<?php echo $config_info->facebook_url;?>" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
