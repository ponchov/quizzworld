...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/tests/twist_add_question_wizard/<?php echo $test_id; ?>/<?php echo $question_num ;?>" method="post" enctype="multipart/form-data" >  
				...
				<?php
...

					{
						...
						?>
							...
							<a href="<?php echo site_url();?>admin/tests/twist_test_wizard_result_option/<?php echo $test_id; ?>"><button style="margin:auto 10px;" type="button" class="btn btn-info btn-lg col-sm-2">Add Result </button></a> 

							<a href="<?php echo site_url();?>admin/tests/twist_test_add_wizard"><button style="margin:auto 10px;" type="button" class="btn btn-primary btn-lg col-sm-2">Add New Test </button></a>
