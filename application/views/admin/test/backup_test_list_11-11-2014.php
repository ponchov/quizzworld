	...
	<div class="row">
		...
		<?php if($this->session->userdata('user_type') == 1) { ?><a href="<?php echo site_url();?>admin/tests/test_add/<?php echo $lan; ?>"><button class="btn pull-right btn-primary" type="button">+Add new</button></a><?php  } ?>		
				...
				{	
					...
					<tr>
						...
						<td data-title="Action">
							...
							<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/test_edit/<?php echo $row->testid;?>/<?php echo $lan; ?>"><span title="Edit" class="glyphicon glyphicon-pencil"></span> </a> &nbsp; <?php } ?>

							<?php if($this->session->userdata('user_type') == 1) { ?><a href="<?php echo site_url();?><?php echo $lan; ?>/<?php echo $row->alias;?>.html" target="_blank"><span title="View" class="glyphicon glyphicon-search"></span></a> &nbsp; <?php } ?>
							...
							<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/result_option/<?php echo $row->testid;?>/<?php echo $lan; ?>"><span class="glyphicon glyphicon-wrench" title="Result"></span></a> &nbsp; <?php } ?>

							<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/questions/<?php echo $row->testid;?>/<?php echo $lan; ?>"><span class="glyphicon glyphicon-question-sign" title="Quesitons"></span></a> &nbsp; <?php } ?>
							...
							<a onclick="javascript: return confirm('Are you sure to delete this?')" href="<?php echo site_url();?>admin/tests/test_delete/<?php echo $row->tests_id;?>/<?php echo $lan; ?>"> <span title="Delete" class="glyphicon glyphicon-trash"></span></a>  &nbsp; 
