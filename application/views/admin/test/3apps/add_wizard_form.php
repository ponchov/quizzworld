...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/tests/apps_test_add_wizard" method="post" enctype="multipart/form-data">  
		...
		?>
          ...
          <div class="col-md-offset-4 col-sm-offset-4">
				...
				<input type="hidden" name="add_3apps_test" value="add_3apps_test" />
