...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/tests/add_face_result_option/<?php echo $test_info->tests_id;?>/<?php echo $result_num;?>" method="post" enctype="multipart/form-data">  
				 ...
				 <?php
...

					{
						...
						?>
						 ...
						 <a href="<?php echo site_url();?>admin/tests/face_test"><button style="margin:auto 10px;" type="button" class="btn btn-primary btn-lg col-sm-2">New Test </button></a>
