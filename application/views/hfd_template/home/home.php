...
<div class="col-xs-12 col-sm-12 col-md-12 " style="padding:5px 0;">
	<div class="col-xs-12 col-sm-8 col-md-9"  id="left_part">
		<div id="latest_headlineArea" class="col-sm-12" style="width:100%; padding-bottom:5px;"><span id="latest_headline"><?php echo $this->lang->line('latest'); ?> <?php echo $quiz_type; ?></span></div>
	...
	<div class="col-xs-12 col-sm-4 col-md-3" style="padding:0;" id="right_part">
		<div class="col-sm-12 top_headline" style="width:100%; padding-bottom:19px;"><span id="top_headline"><?php echo $this->lang->line('top4'); ?></span></div>
		<div class="col-sm-12" id="right_panel">
			...
			?>
				...
				<div id="footer_links" class="text-center" style="border:1px #CCCCCC solid;  margin:15px; padding:15px 20px;">
					...
					<div class="copyRight">
					<?php /*?><a href="<?php echo site_url();?>"><?php echo $config_info->site_title;?></a><?php */?> &copy; <?php echo date('Y');?>. <?php echo $this->lang->line('copyright');?>
					</div>
				</div>
			</div>
			<div style="clear:both;"></div>
