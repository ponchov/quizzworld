	...
	<div class="col-xs-12 col-sm-7 col-md-8">
		...
		<a  href="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/add_slider"><button class="btn pull-right btn-primary" type="button">+Add new sliding</button></a>
		<a href="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/add"><button style="margin:0px 10px;" class="btn pull-right btn-primary" type="button">+Add new</button></a>
