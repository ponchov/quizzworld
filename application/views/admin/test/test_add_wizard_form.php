...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/tests/test_add_wizard" method="post" enctype="multipart/form-data">  
		...
		<div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3  control-label no-padding-right">Pre Description </label>

			<div class="col-xs-12 col-sm-5">

				<span class="block input-icon input-icon-right">

					<textarea name="result_text" id="result_text" class="form-control"></textarea>						
			...
			<div class="col-sm-4">
				...
				<small>Please add pre-text, which will be shown on result page before the result itself (i.e. for test 'What Is Your Floral Name?' this would be 'Your Floral Name Is' -> 'Poppy' or 'Rose'</span></small>
