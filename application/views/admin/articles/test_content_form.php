...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/articles/test_content/<?php echo $testid; ?>/<?php echo $lang_code; ?>" method="post" enctype="multipart/form-data">  
		 ...
		 <div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Article Title</label>
		...
		?>
		<div class="form-group">
			<label for="inputInfo" class="col-xs-12 col-sm-3  control-label no-padding-right">Article Subtitle</label>
			<div class="col-xs-12 col-sm-7">
				<span class="block input-icon input-icon-right">
		...
		<div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Article Snippet</label>

			<div class="col-xs-12 col-sm-7">

				<span class="block input-icon input-icon-right">					
					<?php if(!($lang_code == "en")) echo get_testMeta($eng_test_info->tests_id,'article_snippet'); ?>
					<textarea name="article_snippet" id="article_snippet" class="form-control"><?php if($test_info) echo get_testMeta($test_info->tests_id,'article_snippet');?></textarea>					
		...
		<div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Article Category</label>
		...
		<?php /*?><div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Article Snippet 2</label>

			<div class="col-xs-12 col-sm-7">

				<span class="block input-icon input-icon-right">					
					<?php if(!($lang_code == "en")) echo get_testMeta($eng_test_info->tests_id,'article_snippet_2'); ?>
					<textarea name="article_snippet_2" id="article_snippet_2" class="form-control required"><?php if($test_info) echo get_testMeta($test_info->tests_id,'article_snippet_2');?></textarea>					
		...
		<div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Article Snippet 3</label>

			<div class="col-xs-12 col-sm-7">

				<span class="block input-icon input-icon-right">					
					<?php if(!($lang_code == "en")) echo get_testMeta($eng_test_info->tests_id,'article_snippet_3'); ?>
					<textarea name="article_snippet_3" id="article_snippet_3" class="form-control required"><?php if($test_info) echo get_testMeta($test_info->tests_id,'article_snippet_3');?></textarea>					
		 ...
		 <div class="form-group">
			...
			<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Article Content</label>
