<form action="<?php echo site_url();?>admin/widgets/widget_content/<?php echo $en_widget_info->widgetid;?>/<?php echo $lang;?>" method="post" enctype="multipart/form-data">
 <div class="form-group">
	<label for="exampleInputPassword1">Title</label>
	<div class="row">
		<div class="col-sm-6">
			<input type="text" class="form-control" id="title" readonly="readonly" name="title" value="<?php echo $en_widget_info->title;?>">
		</div>
	</div>
 </div>
 <div class="form-group">
 ...
 <div class="checkbox">
  ...
  <input type="hidden" name="widget_code" value="<?php echo $en_widget_info->widget_code;?>" />
