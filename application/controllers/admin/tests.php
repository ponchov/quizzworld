...
class Tests extends CI_Controller {      
	...
	{	
		...
		$this->session->set_userdata('search_template','');
		$this->session->set_userdata('search','');
	...
	{	
		...
		{	
			$this->session->set_userdata('search_template',$this->input->post('template'));			
		}
		...
		//echo $this->session->userdata('search_template');
		//echo $lang_code;
		$total_rows = $this->test_model->get_total_simple_list($lang_code);
 ...
 function result_option_edit($result_option_id,$id,$lang_code='',$referance='default')

	{
		...
		else
		{
			...
			$data['en_result_option']=$this->test_model->get_result_option($result_option_id,'en');
