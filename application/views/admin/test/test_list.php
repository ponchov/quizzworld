	...
	?>
		<div class="alert alert-danger">  
		  <a class="close" data-danger="alert">x</a>  
	...
	{
		$search_realtest=$this->session->userdata('search_realtest');
	}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-4 col-md-4 ">
			...
			<form class="form-horizontal" action="<?php echo site_url(); ?>admin/tests/search_tests/<?php echo $lang; ?>/0" method="post" id="search_form">
		...
		<div class="col-xs-12 col-sm-8 col-md-8">
			<?php /*?><?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/apps_test_add_wizard"><button class="btn pull-right btn-primary" type="button"  style="margin:0 5px;">+Add name's test</button></a><?php } ?>
			<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/twist_test_add_wizard"><button class="btn pull-right btn-primary" type="button"  style="margin:0 5px;">+Add knowledge test</button></a><?php } ?>
			<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/real_test_add_wizard"><button class="btn pull-right btn-primary" type="button"  style="margin:0 5px;">+Add real test</button></a><?php } ?>
			<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/test_add_wizard/"><button class="btn pull-right btn-primary" type="button"  style="margin:0 5px;">+Add new 2</button></a><?php } ?><?php */?>
			<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/tests/add"><button class="btn pull-right btn-primary" type="button">+Add new</button></a><?php  } ?>		
			<?php if($this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 3) { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?status=2"><button style="margin:0 5px;" class="btn pull-right  <?php if($status == 2) echo "btn-success"; ?>" type="button">Inactive</button></a>
			<a  href="<?php echo site_url();?>admin/tests/search_tests/?status=1"><button class="btn pull-right  <?php if($status == 1) echo "btn-success"; ?>" type="button">Active</button></a><?php } ?>
			
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=6" class="btn pull-right"><img src="<?php echo base_url(); ?>/assets/img/fa.png" /></a><?php } ?>
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=5" class="btn pull-right"><img src="<?php echo base_url(); ?>/assets/img/f.png" /></a><?php } ?>
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=4" class="btn pull-right"><img src="<?php echo base_url(); ?>/assets/img/h.jpg" /></a><?php } ?>
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=3" class="btn pull-right"><img src="<?php echo base_url(); ?>/assets/img/3.jpg" /></a><?php } ?>
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=2" class="btn pull-right"><img src="<?php echo base_url(); ?>/assets/img/t.jpg" /></a><?php } ?>
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=1" class="btn pull-right"><img src="<?php echo base_url(); ?>/assets/img/r.png" /></a><?php } ?>
			<?php if($this->session->userdata('user_type') == 1)  { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?realtest=0" class="btn pull-right gray_btn"><img src="<?php echo base_url(); ?>/assets/img/gray.png" /></a><?php } ?>
	...
	$(document).ready(function() {
		...
		$(document).on('click','.single_col',function() {
...

			{
				...
				var url="<?php echo site_url();?>admin/tests/save_test_col/<?php echo $lang;?>/<?php echo $page_number;?>";
		...
		$(document).on('click','.status',function() {
			...
			{
				$.post(url,{test_id:test_id,option:2},function(data) { //alert(data);
					$('#overlay').remove();
					$('#test_container').html(data);
				});
			}
		...
		$(document).on('click','.editor_control',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();	
			var url="<?php echo site_url();?>admin/tests/set_editor_control/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/tests/set_editor_control/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
			if(this.checked)
		...
		$(document).on('click','.featured',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();	
			var url="<?php echo site_url();?>admin/tests/set_featured/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/tests/set_featured/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
			if(this.checked)
		...
		$(document).on('click','.graphic_control',function() {
			...
			var url="<?php echo site_url();?>admin/tests/set_graphic_control/<?php echo $lang;?>/<?php echo $page_number;?>";
			...
			<?php
				...
				var url="<?php echo site_url();?>admin/tests/set_graphic_control/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
		...
		$(document).on('click','.default_ads',function() {
			...
			var url="<?php echo site_url();?>admin/tests/change_ads_settings/<?php echo $lang;?>/<?php echo $page_number;?>";
			...
			<?php
				...
				var url="<?php echo site_url();?>admin/tests/change_ads_settings/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
