...
<html xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
  ...
  <head>
	...
	<meta property="og:title" content="<?php if(isset($meta_title)) echo $meta_title; else if(isset($page_title)) echo $page_title; ?>" />
		...
		<div class="container"> 
			<div class="col-xs-12 col-sm-12 col-md-12 headerArea">
				...
				<div class="navbar-header hidden-xs hidden_new_rang">			
					<a class="navbar-brand " href="<?php echo site_url();?>"><img class="img-resposive" src="<?php echo base_url();?>assets/img/<?php echo $config_info->logo;?>" alt="" style="height:50px;"/></a>
			   </div>
