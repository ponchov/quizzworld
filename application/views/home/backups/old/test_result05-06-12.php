...
<div class="row">
	<?php if($config_info->result_adsense && $tests_info->result_top == 1) { ?><div class="adsense_top text-center"><?php echo htmlspecialchars_decode($config_info->result_adsense);?></div> <?php } ?>
	<div class="sky_ad_left"><?php if($config_info->result_sky_left_adsense && $tests_info->result_left == 1) echo htmlspecialchars_decode($config_info->result_sky_left_adsense);?></div>
	<div id="main_container" class="col-xs-12 col-sm-10 col-md-8 ">
		...
		<div style="clear:both;"></div>
			<div id="fb_like_share" class="text-center" >
		...
		<div style="clear:both;"></div>
		<?php
		if($config_info->result_middle_adsense  && $tests_info->result_middle == 1)
		{
		?>
		<div class="adsense_bottom text-center">
		<?php echo htmlspecialchars_decode($config_info->result_middle_adsense);?>
		</div>
		<?php
		}
		else if($config_info->result_middle_adsense  && $tests_info->result_middle2 == 1)
		{
			?>
				<div class="adsense_bottom text-center">
		<?php echo htmlspecialchars_decode($config_info->result_middle_adsense2);?>
		</div>
			<?php
		}
		?>
			...
			<div id="fb_comments" class="">
				...
				<?php /*?><div class="fb-comments visible-sm"  data-width="420" data-href="<?php echo site_url();?><?php echo $tests_info->alias.".html";?>" data-numposts="5" data-colorscheme="light"></div>
				<div class="fb-comments visible-xs"  data-width="250" data-href="<?php echo site_url();?><?php echo $tests_info->alias.".html";?>" data-numposts="5" data-colorscheme="light"></div><?php */?>
		...
		<div style="clear:both;"></div>
		<?php if($config_info->result_bottom_adsense  && $tests_info->result_bottom == 1) { ?><div class="adsense_bottom text-center"><?php echo htmlspecialchars_decode($config_info->result_bottom_adsense);?></div> <?php } ?>
		<div class="like_box ">
	...
	<div class="sky_ad_right" ><?php if($config_info->result_sky_right_adsense && $tests_info->result_right == 1) echo htmlspecialchars_decode($config_info->result_sky_right_adsense);?></div>
</div>
