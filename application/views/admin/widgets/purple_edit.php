<form class="form-horizontal" action="<?php echo site_url();?>admin/widgets/purple_edit/<?php echo $widget_info->purple_widget_id;?>" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
		...
		<div class="col-xs-12 col-sm-5">
		  ...
		  <input type="hidden" name="purple_widgetid" value="<?php echo $widget_info->purple_widgetid;?>" />
