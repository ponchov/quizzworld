...
<div class="row">
	...
	?> 
		...
		<div class="adsense_top text-center"><?php if($tests_info->default_ads == 2 && $tests_info->test_top_adsense) echo htmlspecialchars_decode($tests_info->test_top_adsense); else if($config_info->test_top_adsense) echo htmlspecialchars_decode($config_info->test_top_adsense);?></div> 
	...
	<div class="sky_ad_left">
		...
		<?php 
			...
			else if($config_info->test_sky_left_adsense && $tests_info->test_left == 1) echo htmlspecialchars_decode($config_info->test_sky_left_adsense);
	...
	<?php
...

		{
			...
			else if($config_info->test_middle_adsense) $ads+=1;

			if($tests_info->default_ads == 2 && $tests_info->test_middle_adsense2) $ads+=1;

			else  if($config_info->test_middle_adsense2) $ads+=1;
		...
		<?php if($tests_info->default_ads == 2 && $tests_info->test_middle_adsense) echo htmlspecialchars_decode($tests_info->test_middle_adsense); else if($config_info->test_middle_adsense) echo htmlspecialchars_decode($config_info->test_middle_adsense);?>
...

		{
			...
			?>
				...
				<div class="adsense_bottom text-center <?php if($ads == 2) echo 'col-xs-12 col-sm-6 col-md-6';?>" >
					...
					<?php if($tests_info->default_ads == 2 && $tests_info->test_middle_adsense2) echo htmlspecialchars_decode($tests_info->test_middle_adsense2); else if($config_info->test_middle_adsense2) echo htmlspecialchars_decode($config_info->test_middle_adsense2);?>
	...
	<?php if($tests_info->test_bottom == 1)
	 ...
	 ?>
		 ...
		 <div class="adsense_bottom text-center"><?php if($tests_info->default_ads == 2 && $tests_info->test_bottom_adsense) echo htmlspecialchars_decode($tests_info->test_bottom_adsense); else if($config_info->test_bottom_adsense) echo htmlspecialchars_decode($config_info->test_bottom_adsense);?></div> 
...
<div class="sky_ad_right" >
	...
	<?php 
		...
		else if($config_info->test_sky_right_adsense && $tests_info->test_right == 1)  echo htmlspecialchars_decode($config_info->test_sky_right_adsense);
