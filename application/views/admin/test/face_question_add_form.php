...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/tests/add_question_face/<?php echo $test_id; ?>/<?php echo $question_num ;?>" method="post" >  
				...
				<?php
...

					{
						...
						?>
							...
							<a href="<?php echo site_url();?>admin/tests/add_face_result_option/<?php echo $test_id; ?>"><button style="margin:auto 10px;" type="button" class="btn btn-primary btn-lg col-sm-2">Add Result </button></a> 
