...
<html xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
  ...
  <head>
	...
	<link href="<?php echo base_url(); ?>assets/templates/<?php echo $this->template;?>/css/slick.css" rel="stylesheet">
    ...
    <script src="<?php echo base_url(); ?>assets/js/bootstrap.min.js"></script>
	 <script src="<?php echo base_url(); ?>assets/templates/<?php echo $this->template;?>/js/slick.js"></script>
	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="slide-nav">
		<div class="container"> 
			<div class="col-xs-12 col-sm-12 col-md-12 headerArea">
				<div class="navbar-header col-xs-3 visible-xs visible_new_rang">
				...
				<div class="navbar-header hidden-xs hidden_new_rang">			
					<a class="navbar-brand hidden-xs logo" href="<?php echo site_url();?>"><img class="img-resposive" src="<?php echo base_url();?>assets/img/<?php echo $config_info->logo;?>" alt="" style="height:48px;"/></a>
			   </div>
				...
				<div class="burger_menu">	
				  ...
				  <ul class="nav navbar-nav">
				    <li style="padding: 10px 6px 6px;">
							...
							<?php 
								if($languages)
								{
									...
									{
									if($language->language_code == 'pl') continue;
									$lang_code="";
					...
					<li class="visible-xs visible_new_rang"><a class="button" href="<?php echo site_url();?>"><?php echo $this->lang->line('home');?></a></li>
					<li><a class="button" href="<?php echo site_url();?>apps.html"><?php echo $this->lang->line('apps');?></a></li>
					<li><a class="button" href="<?php echo site_url();?>name.html"><?php echo $this->lang->line('name_apps');?></a></li>
					<li><a class="button" href="<?php echo site_url();?>trivia.html"><?php echo $this->lang->line('trivia');?></a></li>
					<li><a class="button" href="<?php echo site_url();?>personality-quiz.html"><?php echo $this->lang->line('personality_quizz');?></a></li>
					
					<?php /*?><li><a class="button" href="<?php echo site_url();?>lists.html"><?php echo $this->lang->line('list');?></a></li>	
					<li><a class="button" href="<?php echo site_url();?>articles.html"><?php echo $this->lang->line('article');?></a></li>
					<li><a class="button" href="<?php echo site_url();?>videos.html"><?php echo $this->lang->line('video');?></a></li>	<?php */?>						
				</ul>	
				</div>			  
			   </div>
			   
				<div class="navbar-header  domain_like_box_mob visible-xs visible_new_rang col-xs-6" style="padding-top:3px; text-align:center;">				
					<a class=" logo" href="<?php echo site_url();?>"><img class="img-resposive" src="<?php echo base_url();?>assets/img/<?php echo $config_info->logo;?>" alt="" style="height:46px; padding-top:2px;"/></a>
					</div>
