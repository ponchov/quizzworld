<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/add_slider/<?php echo $lan; ?>" method="post" enctype="multipart/form-data">  
