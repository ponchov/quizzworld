...
<div class="row22">
	...
	//{
		...
		{ 
		?> 
			<div class="adsense_top text-center "><?php if($tests_info->default_ads == 2 && $tests_info->question_top_adsense) echo htmlspecialchars_decode($tests_info->question_top_adsense); else if($ads_info->question_top_adsense) echo htmlspecialchars_decode($ads_info->question_top_adsense);?></div> 
		<?php
	...
	
		 {
			...
			<div class="adsense_top text-center "><?php if($tests_info->default_ads == 2 && $tests_info->question_top_adsense2) echo htmlspecialchars_decode($tests_info->question_top_adsense2); else if($ads_info->question_top_adsense2) echo htmlspecialchars_decode($ads_info->question_top_adsense2);?></div>
	...
	<div class="sky_ad_left">
		...
		<?php 
			...
			//{
				...
				else if($ads_info->question_sky_left_adsense && $tests_info->question_left == 1) echo htmlspecialchars_decode($ads_info->question_sky_left_adsense);
			//}
		?>
	...
	<?php
		...
		//{
	...
	
			{
				...
				else if($ads_info->question_bottom_adsense) $ads+=1;
	
				if($tests_info->default_ads == 2 && $tests_info->question_bottom_adsense2) $ads+=1;
	
				else  if($ads_info->question_bottom_adsense2) $ads+=1;
			...
			<?php if($tests_info->default_ads == 2 && $tests_info->question_bottom_adsense) echo htmlspecialchars_decode($tests_info->question_bottom_adsense); else if($ads_info->question_bottom_adsense) echo htmlspecialchars_decode($ads_info->question_bottom_adsense);?>
	...
	
			{
				...
				?>
					...
					<div class="adsense_bottom text-center  <?php if($ads == 2) echo 'col-xs-12 col-sm-6 col-md-6';?>" >
						...
						<?php if($tests_info->default_ads == 2 && $tests_info->question_bottom_adsense2) echo htmlspecialchars_decode($tests_info->question_bottom_adsense2); else if($ads_info->question_bottom_adsense2) echo htmlspecialchars_decode($ads_info->question_bottom_adsense2);?>
	...
	<?php 
		if($question_num == 3)
		{
			...
			else if($ads_info->question_sky_right_adsense && $tests_info->question_right == 1)  echo htmlspecialchars_decode($ads_info->question_sky_right_adsense);
		}
	?>
