<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/articles/add/<?php echo $lan; ?>" method="post" enctype="multipart/form-data">  
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-7">
				...
				<span class="block input-icon input-icon-right">					
					...
					<textarea name="article_snippet" id="article_snippet" class="form-control "></textarea>					
		...
		<!--<div class="form-group">
			...
			<div class="col-xs-12 col-sm-7">
				...
				<span class="block input-icon input-icon-right">					
					...
					<textarea name="article_snippet_2" id="article_snippet_2" class="form-control required"></textarea>					
		...
		<!--<div class="form-group">
			...
			<div class="col-xs-12 col-sm-7">
				...
				<span class="block input-icon input-icon-right">					
					...
					<textarea name="article_snippet_3" id="article_snippet_3"  class="form-control required"></textarea>					
