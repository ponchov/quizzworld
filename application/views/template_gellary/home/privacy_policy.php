...
<div class="container">
	...
	<div id="main_container" class="col-xs-12 col-sm-10 col-md-8 " style="margin:auto; float:none !important;">
				...
				<div class="well">
					...
					<center><h4><strong>Privacy Policy for <a href="<?php echo site_url();?>">www.quizz.world</a></strong></h4>

<h5>
					<p>The privacy of our visitors to <a href="<?php echo site_url();?>">www.quizz.world</a> is important to us.</p>
					...
					<p>We also use third party advertisements on <a href="<?php echo site_url();?>">www.quizz.world</a> to support our site. Some of these advertisers may use technology such as cookies and web beacons when they advertise on our site, which will also send these advertisers (such as Google through the Google AdSense program) information including your IP address, your ISP , the browser you used to visit our site, and in some cases, whether you have Flash installed. This is generally used for geotargeting purposes (showing New York real estate ads to someone in New York, for example) or showing certain ads based on specific sites visited (such as showing cooking ads to someone who frequents cooking sites).</p>
