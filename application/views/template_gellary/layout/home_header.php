		...
		<div class="container"> 
			<div class="col-xs-12 col-sm-12 col-md-12 headerArea">
				...
				<div class="navbar-header hidden-xs hidden_new_rang">			
					<a class="navbar-brand  logo" href="<?php echo site_url();?>"><img class="img-resposive" src="<?php echo base_url();?>assets/img/<?php echo $config_info->logo;?>" alt="" style="height:48px;"/></a>
			   </div>
				...
				<div class="navbar-header  domain_like_box_mob visible-xs col-xs-6 visible_new_rang" style="padding-top:3px; text-align:center;">				
