	...
	<div class="col-xs-12 col-sm-5 col-md-4">
		...
		<form class="form-horizontal" action="<?php echo site_url(); ?>admin/articles/search_tests/<?php echo $lang; ?>/0" method="post" id="search_form">
			<div class="form-group">			
			<div class="col-xs-7 col-sm-8 col-md-8">
				<input class="form-control required" type="text" name="search" id="search" value="<?php if($this->session->userdata('article_search')) echo $this->session->userdata('article_search'); ?>" />
			</div>	
	...
	<div class="col-xs-12 col-sm-7 col-md-8">
		...
		<a href="<?php echo site_url();?>admin/articles/add"><button class="btn pull-right btn-primary" type="button">+Add new</button></a>	
		<?php if($this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 3) { ?><a  href="<?php echo site_url();?>admin/articles/search_tests/?status=2"><button style="margin:0 10px;" class="btn pull-right  <?php if($status == 2) echo "btn-success"; ?>" type="button">Inactive</button></a>
		<a  href="<?php echo site_url();?>admin/articles/search_tests/?status=1"><button class="btn pull-right  <?php if($status == 1) echo "btn-success"; ?>" type="button">Active</button></a><?php } ?>
		...
		<?php
				...
				if($language_list)
				{
					foreach($language_list as $language)
					{
						...
						{
						?>
							<a href="<?php echo site_url();?>admin/articles/index/<?php echo $language->language_code;?>"><span class="label <?php echo $label_class; ?>"><?php echo $language->language_code; ?></span></a>
						<?php 
						}
					}
					...
					<tr>
						...
						<td data-title="Action" valign="middle">
							<table width="100%;">
								...
								<?php if($this->session->userdata('user_type') !=4 ) { ?><a href="<?php echo site_url();?>admin/articles/edit/<?php echo $row->testid;?>/<?php echo $lang; ?>"><span title="Edit" class="glyphicon glyphicon-pencil"></span> </a> &nbsp; <?php } ?>
	
								<?php if($this->session->userdata('user_type') == 1) { ?><a href="<?php echo site_url();?>article/<?php echo $row->alias;?>.html" target="_blank"><span title="View" class="glyphicon glyphicon-search"></span></a> &nbsp; <?php } ?>
	
								<a href="<?php echo site_url();?>admin/articles/test_details/<?php echo $row->testid;?>/<?php echo $lang;?>"><span class="glyphicon glyphicon-eye-open" title="Preview"></span></a> &nbsp; 
								...
								<a onclick="javascript: return confirm('Are you sure to delete this?')" href="<?php echo site_url();?>admin/articles/test_delete/<?php echo $row->testid;?>/<?php echo $lang; ?>"> <span title="Delete" class="glyphicon glyphicon-trash"></span></a>  &nbsp; 
								...
								<?php 
										...
										if($language_list)
										{
											foreach($language_list as $language)
											{
												...
												{
											?>																						
												 <a class="language_level" href="<?php echo site_url();?>admin/articles/test_content/<?php echo $row->testid;?>/<?php echo $language->language_code;?>"><span class="label <?php echo $label_class; ?>"><?php echo $language->language_code; ?></span></a>
												&nbsp;
											<?php 
												}
											}
	...
	$(document).ready(function() {
		...
		$(document).on('click','.single_col',function() {
...

			{
				...
				var url="<?php echo site_url();?>admin/articles/save_test_col/<?php echo $lang;?>/<?php echo $page_number;?>";
		...
		$(document).on('click','.status',function() {
			...
			var url="<?php echo site_url();?>admin/articles/change_test_status/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/articles/change_test_status/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
		...
		$(document).on('click','.editor_control',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();			
			var url="<?php echo site_url();?>admin/articles/set_editor_control/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/articles/set_editor_control/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
		...
		$(document).on('click','.featured',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();			
			var url="<?php echo site_url();?>admin/articles/set_featured/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/articles/set_featured/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
		...
		$(document).on('click','.graphic_control',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();			
			var url="<?php echo site_url();?>admin/articles/set_graphic_control/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/articles/set_graphic_control/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
			if(this.checked)
		...
		$(document).on('click','.default_ads',function() {
			var overlay = $('<div id="overlay"><div id="indicator"><img src="<?php echo base_url();?>assets/img/ajax-loader.gif" /></div> </div>');
			overlay.appendTo(document.body);
			var url="<?php echo site_url();?>admin/articles/change_ads_settings/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/articles/change_ads_settings/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
			var test_id=$(this).val();
