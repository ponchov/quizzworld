	...
	<div class="col-xs-12 col-sm-7 col-md-8">
		...
		<?php if($this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 3) { ?><a  href="<?php echo site_url();?>admin/tests/search_tests/?status=2"><button style="margin:0 10px;" class="btn pull-right  <?php if($status == 2) echo "btn-success"; ?>" type="button">Inactive</button></a>
								...
								<?php 
										...
										if($language_list)
										{
											foreach($language_list as $language)
											{
												...
												{
											?>																						
												 <a class="language_level" href="<?php echo site_url();?>admin/tests/test_content/<?php echo $row->testid;?>/<?php echo $language->language_code;?>"><span class="label <?php echo $label_class; ?>"><?php echo $language->language_code; ?></span></a>
												&nbsp;
											<?php 
												}
											}
