...
<div class="row">
	...
	?> 
		...
		<div class="adsense_top text-center"><?php if($tests_info->default_ads == 2 && $tests_info->question_top_adsense) echo htmlspecialchars_decode($tests_info->question_top_adsense); else if($config_info->question_top_adsense) echo htmlspecialchars_decode($config_info->question_top_adsense);?></div> 
	...
	<?php
...

	 {
		...
		<div class="adsense_top text-center"><?php if($tests_info->default_ads == 2 && $tests_info->question_top_adsense2) echo htmlspecialchars_decode($tests_info->question_top_adsense2); else if($config_info->question_top_adsense2) echo htmlspecialchars_decode($config_info->question_top_adsense2);?></div>
...

					{
						...
						?>
							...
							<div class="question_block btn-group-vertical btn-group btn-group-lg current">
								...
								<p class="text-center"><?php echo $this->lang->line('question');?> <?php echo $i;?> <?php echo $this->lang->line('out_of');?> <?php echo $total_questions;?></p>
