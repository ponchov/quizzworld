...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/articles/edit/<?php echo $test_info->testid;?>/<?php echo $lan; ?>/<?php echo $referance;?>" method="post" enctype="multipart/form-data">  
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-7">
				...
				<span class="block input-icon input-icon-right">					
					...
					<textarea name="article_snippet" id="article_snippet" class="form-control"><?php echo get_testMeta($test_info->tests_id,'article_snippet');?></textarea>					
		...
		<?php /*?><div class="form-group">
			...
			<div class="col-xs-12 col-sm-7">
				...
				<span class="block input-icon input-icon-right">					
					...
					<textarea name="article_snippet_2" id="article_snippet_2" class="form-control required"><?php echo get_testMeta($test_info->tests_id,'article_snippet_2');?></textarea>					
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-7">
				...
				<span class="block input-icon input-icon-right">					
					...
					<textarea name="article_snippet_3" id="article_snippet_3" class="form-control required"><?php echo get_testMeta($test_info->tests_id,'article_snippet_3');?></textarea>					
