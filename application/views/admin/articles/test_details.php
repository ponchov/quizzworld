...
<div class="row test_detais">
	<?php if($this->session->userdata('user_type') !=4 ) { ?><div><a href="<?php echo site_url(); ?>admin/articles/edit/<?php echo $test_info->testid; ?>/<?php echo $lang_code; ?>/details" target="_blank" class="btn btn-primary pull-right">Edit</a></div><?php } ?>
	<div style="clear:both; height:10px;"></div>
	<h2><?php echo $test_info->title; ?></h2>
    <h5><?php echo get_testMeta($test_info->tests_id,'article_snippet');?></h5>
	<p>
	<?php
		if($test_info->image)
	...
	<?php if($this->session->userdata('user_type') == 3 || $this->session->userdata('user_type')== 4 ) { ?>
		<div class="comments_area">
			...
			?>
			<form class="form-horizontal" action="<?php echo site_url(); ?>admin/articles/edit_comments" method="post">
	...
	<?php } ?>
     ...
     <h3><?php echo get_testMeta($test_info->tests_id,'article_snippet_2');?></h3>
	 <p><?php echo nl2br($test_info->description); ?></p>
	 <h3><?php echo get_testMeta($test_info->tests_id,'article_snippet_3');?></h3>
	 ...
	 <?php
		...
		<form action="<?php echo site_url(); ?>admin/articles/all_image_added" method="post">
		...
		<form action="<?php echo site_url(); ?>admin/articles/all_content_ready" method="post">
