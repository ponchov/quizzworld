...
<form class="form-horizontal" id="add_form" action="<?php echo site_url();?>admin/tests/twist_add_answer_wizard/<?php echo $test_id;?>/<?php echo $question_num;?>/<?php echo $test_question_id; ?>" method="post" >  
