	...
	<div class="col-xs-12 col-sm-5 col-md-4">
		...
		<form class="form-horizontal" action="<?php echo site_url(); ?>admin/videos/search_tests/<?php echo $lang; ?>/0" method="post" id="search_form">
	...
	<div class="col-xs-12 col-sm-7 col-md-8">
		...
		<a href="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/add"><button class="btn pull-right btn-primary" type="button">+Add new</button></a>		
		<?php if($this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 3) { ?><a  href="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/search_tests/?status=2"><button style="margin:0 10px;" class="btn pull-right  <?php if($status == 2) echo "btn-success"; ?>" type="button">Inactive</button></a>
		<a  href="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/search_tests/?status=1"><button class="btn pull-right  <?php if($status == 1) echo "btn-success"; ?>" type="button">Active</button></a><?php } ?>
		...
		<?php
				...
				if($language_list)
				{
					foreach($language_list as $language)
					{
						...
						{
						?>
							<a href="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/index/<?php echo $language->language_code;?>"><span class="label <?php echo $label_class; ?>"><?php echo $language->language_code; ?></span></a>
						<?php 
						}
					}
					...
					<tr>
						...
						<td data-title="Action" valign="middle">
							<table width="100%;">
								...
								<?php if($this->session->userdata('user_type') == 1) { ?><a href="<?php echo site_url();?>videos/<?php echo $row->alias;?>.html" target="_blank"><span title="View" class="glyphicon glyphicon-search"></span></a> &nbsp; <?php } ?>
	...
	$(document).ready(function() {
		...
		$(document).on('click','.single_col',function() {
...

			{
				...
				var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/save_test_col/<?php echo $lang;?>/<?php echo $page_number;?>";
		...
		$(document).on('click','.status',function() {
			...
			var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/change_test_status/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/change_test_status/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
		...
		$(document).on('click','.editor_control',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();			
			var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/set_editor_control/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/set_editor_control/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
		...
		$(document).on('click','.featured',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();			
			var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/set_featured/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/set_featured/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
		...
		$(document).on('click','.graphic_control',function() {
			...
			overlay.appendTo(document.body);
			var test_id=$(this).val();			
			var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/set_graphic_control/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/set_graphic_control/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
			if(this.checked)
		...
		$(document).on('click','.default_ads',function() {
			var overlay = $('<div id="overlay"><div id="indicator"><img src="<?php echo base_url();?>assets/img/ajax-loader.gif" /></div> </div>');
			overlay.appendTo(document.body);
			var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/change_ads_settings/<?php echo $lang;?>/<?php echo $page_number;?>";
			<?php
				if(!empty($_GET['status']))
				{
				?>
				var url="<?php echo site_url();?>admin/<?php echo $this->post_type;?>/change_ads_settings/<?php echo $lang;?>/<?php echo $page_number;?>?status=<?php echo $_GET['status'];?>";
				<?php
				}
			?>
			var test_id=$(this).val();
