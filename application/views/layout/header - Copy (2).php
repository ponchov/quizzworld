		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-2 col-md-2 hidden-xs hidden-sm text-center logo" style="float:left;">
					<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/img/logo.gif" style="height:31px;  float:right;"/></a>
				</div>
				...
				<?php /*?><div class="col-xs-2 col-sm-2 col-md-2 logo">
					...
					<div class="col-xs-8 col-sm-5 col-md-5 facebook_like" style="">				
							<div class="hidden-md hidden-lg text-center logo" style="float:left;">
								<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/img/logo.gif" style="height:35px;  float:right;"/></a>
							</div>
							...
							<div class="domain_like_box_mobile visible-xs" >
					...
					<div class="col-xs-4 col-sm-7 col-md-7 top_menu ">				
						 <ul class="nav navbar-nav">
								...
								<?php } ?>
								<li class="<?php if($active_menu == 'top') echo 'active';?>"><a class="button" href="<?php echo site_url();?>top.html">TOP</a></li>
								<li class="<?php if($active_menu == 'random') echo 'active';?>"><a class="button" href="<?php echo site_url();?>random.html">Random</a></li>								
							  </ul>
					</div>	
