...
<div class="col-xs-12 col-sm-12 col-md-12" style="padding:0;">
	<div class="col-xs-12 col-sm-8 col-md-8" id="list_left_panel">
		<div id="left_content">
			...
			<div class="social_link">
				...
				<?php
				$share_url =site_url()."article/".$tests_info->alias.".html";
			...
			<?php /*?><div class="snipet_2"><?php echo get_testMeta($tests_info->tests_id,'article_snippet_2');?></div><?php */?>
			<div class="description"><?php echo $tests_info->description; ?></div><br />
			<?php /*?><div class="snipet_3"><?php echo get_testMeta($tests_info->tests_id,'article_snippet_3');?></div><?php */?>
			...
			<div class="video col-xs-12, col-md-12">
				<?php
						...
						else if($video_type == "youtube")
						{
							...
							?>
								<iframe  id="youtube_video" class="youtube_videoss" src="<?php echo $youtube_url;?>" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
							<?php 
						}
						else if($video_type == "vimo")
						{
							...
							?>
							 ...
							 <iframe id="youtube_video" src="http://player.vimeo.com/video/<?php echo $vimo_id; ?>"     frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
							<?php 
						}
					?>					
	...
	-->			</div>
		...
		<div id="bottom_list">
			...
			<?php
			$items=$this->home_model->get_randon_lists('articles',3);
			if($items)
			{
				...
				{ 
					?>
						<div class="col-xs-12 col-md-4 col-sm-4">
							<a href="<?php echo site_url();?>article/<?php echo $item->alias;?>.html">
							...
							<p class="latest_games_caption list_of_item_title">
								<a href="<?php echo site_url();?>article/<?php echo $item->alias;?>.html"><?php echo $item->title;?></a>
							</p>
						</div>
					<?php
				}
	...
	<div class="col-xs-12 col-sm-3 col-md-3 pull-right hidden-xs" id="list_right_panel" >
		<div id="right_top">
